...
public class Reservation {
    ...
    public Reservation(String firstName, String lastName, String discount, String flightDate, String departureAirport,
                       String arrivalAirport, int seatNumber, int adultsCount, int childCount, int bagsCount) {
