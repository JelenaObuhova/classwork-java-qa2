...
public class WorkArounds {
    ...
    private final By CATALOG_ITEM = By.xpath(".//a[@class = 'catalog-taxons-product__name']");
    ...
    public void catalogWorkaround() {
        ...
        try {
            catalogItems.get(35).click();
        } catch (ElementClickInterceptedException e) {
            catalogItems.get(35).click();
        }

        catalogItems.get(35).findElement(CATALOG_ITEM_NAME).click();
    }
